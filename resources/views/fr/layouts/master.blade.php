...
<!-- Required meta tags -->
    ...
    <!-- icon -->
    <link rel="shortcut icon " href="{{asset('img/logolabo.ico')}}">
    ...
    <div id="bar2">
        ...
        <section id="barmenu" class="container">
            ...
            <nav id="nav" class="  navbar sticky-top  navbar-toggleable-md navbar-light ">
                ...
                <i id="mobilemenu" class="navbar-brand hidden-lg-up" href="#">Menu</i>
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                    ...
                    <ul class="container navbar-nav mr-auto mt-2 mt-md-0 nav  ">
                        ...
                        <li class="nav-item  ">
                            <a class="nav-link @if($choix==0) navactive @endif" href="{{url('/fr/')}}">Accueil</a>
                        </li>

                        <li class="nav-item  ">
                            <a class="nav-link @if($choix==1) navactive @endif" href={{url('/fr/research_axes')}}>Axes
                                de Recherche</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link @if($choix==2) navactive @endif"
                               href="{{url('/fr/members')}}">Membres</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link @if($choix==3) navactive @endif" href="{{url('/fr/research_projects')}}">
                                Projets de Recherche</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link @if($choix==4) navactive @endif" href="{{url('/fr/scientific_events')}}">Activités
                                scientifiques</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link @if($choix==5) navactive @endif" href="{{url('/fr/equipments')}}">Equipements</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link @if($choix==6) navactive @endif" href="{{url('/fr/publications')}}">Publications</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link @if($choix==7) navactive @endif" href="{{url('/fr/contact')}}">
                                Contact </a>
                        </li>

                    </ul>

                    <span id="mobilemenu" class="navbar-brand hidden-lg-up " href="#">Langue</span>
                    ...
                    <ul class=" navbar-nav mr-auto mt-2 mt-md-0 nav  ">
                        ...
                        @if (Auth::check() && Auth::user()->is_admin)
                            ...
                            <li class="dropdown " style="margin-bottom: -30px;padding-bottom: -30px;">
                                ...
                                <a href="#" id="loginFlag" class="nav-link" data-toggle="dropdown" role="button"
